...
// Validate ../../src/app/settings/device/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/settings/device">> = Specific
  const handler = {} as typeof import("../../src/app/settings/device/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
